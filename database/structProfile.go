...
type ProfileAccount struct {
	...
	LastLogin datatypes.Date `json:"lastLogin" gorm:"type:timestamp"`
}
...
type ProfileData struct {
	...
	VerifiedAt   datatypes.Time `json:"verifiedAt" gorm:"type:timestamp"`
	...
	Images       string         `json:"images" gorm:"not null;type:varchar(16)"`
}
